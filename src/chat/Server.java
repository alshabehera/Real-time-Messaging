...
public class Server  implements ActionListener{
    ...
    Server(){
        ...
        p1.setBackground(new Color(120, 193, 243));
       ...
       send.setBackground(new Color(120, 193, 243));
    ...
    public static JPanel formatLabel(String out){
        ...
        output.setBackground(new Color(155, 232, 216));
